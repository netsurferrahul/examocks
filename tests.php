...
<html lang="en">
	...
	<div class="card-panel" style="margin-top:0;">
		<div class="container">
			<div class="row">
				<div class="col s12"><a href="">Home</a><i class="tiny material-icons">chevron_right</i><a href=""><?php echo dashesToRealContentGetter($_GET['exam']); ?></a><i class="tiny material-icons">chevron_right</i><?php echo dashesToRealContentGetter($_GET['exam']); ?> Mock Test</div>
				<div class="col s12"><h1><?php echo dashesToRealContentGetter($_GET['exam']); ?> Mock Test</h1></div>
			</div>
		</div>
	</div>
